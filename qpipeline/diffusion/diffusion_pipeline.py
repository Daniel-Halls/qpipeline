...
def diffusion_cmd(
    study_folder: str, qunex_con_image: str, queue: str, no_gpu: bool
) -> str:
    """
    Diffusion qunex cmd
    ...
    if queue:
      ...
      --scheduler="SLURM,time=24:00:00,ntasks=1,cpus-per-task=1,mem-per-cpu=50000,partition={queue},qos=img,gres=gpu:1,jobname=diffusion" """
